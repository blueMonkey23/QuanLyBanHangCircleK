...
console.log(`Started ${SERVICES.length} v2 machine-A processes with ${process.execPath}`);
console.log('Run UI separately with: cd ui && npm run dev');
console.log('Press Ctrl+C to stop all machine-A processes.');
